...
class HDVAE_module(nn.Module):
    def __init__(
        ...
        super(HDVAE_module, self).__init__()
        ...
        self.block1 = HDVAEBlock(in_features=self.feat_hidden2, out_features=self.gcn_hidden1, gcn_out_features=self.gcn_hidden2, num_hops=2, dropout=self.p_drop)
        self.block2 = HDVAEBlock(in_features=self.gcn_hidden2, out_features=self.gcn_hidden1, gcn_out_features=self.gcn_hidden2, num_hops=2, dropout=self.p_drop)
