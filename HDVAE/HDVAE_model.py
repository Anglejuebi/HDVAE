...
from .HDVAE_module import HDVAE_module
...
class hdvae():
    def __init__(
        ...
        self.model = HDVAE_module(self.input_dim, gcn_hidden2=self.gcn_hidden2, lambda_sim=self.lambda_sim).to(self.device).double()
